const NewAuth = require("../NewAuthentication");
...
describe('NewAuthentication entities', () => {
    it('should throw error when payload not contain needed property', () => {
        ...
        expect(() => new NewAuth(payload)).toThrowError('NEW_AUTHENTICATION.NOT_CONTAIN_NEEDED_PROPERTY');
    });
    ...
    it('should throw error when payload not meet data type specification', () => {
        ...
        expect(() => new NewAuth(payload)).toThrowError('NEW_AUTHENTICATION.NOT_MEET_DATA_TYPE_SPECIFICATION');
    });
